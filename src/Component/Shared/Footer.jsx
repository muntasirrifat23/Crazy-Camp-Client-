...
const Footer = () => {
  ...
  <div className='font-semibold '>
        <p>Contact: crazycamp@gmail.com</p>
        <p>Phone: +880123-456-7890</p>
        <p>House:12, Sector 11, Uttara, Dhaka,Bangladesh</p>
      </div>
  ...
  <div>
    <p>Copyright © 2023 - All right reserved by Camp Crazy</p>
  </div>
</footer>
        </div>
    );
